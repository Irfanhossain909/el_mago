...
class RetailerDetailsModelData {
    ...
    factory RetailerDetailsModelData.fromRawJson(String str) => RetailerDetailsModelData.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory RetailerDetailsModelData.fromJson(Map<String, dynamic> json) => RetailerDetailsModelData(
        success: json["success"],
        message: json["message"],
        data: json["data"] == null ? null : RetailerDetailsDataModel.fromJson(json["data"]),
    );
...
class RetailerDetailsDataModel {
    ...
    factory RetailerDetailsDataModel.fromRawJson(String str) => RetailerDetailsDataModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory RetailerDetailsDataModel.fromJson(Map<String, dynamic> json) => RetailerDetailsDataModel(
        id: json["_id"],
        name: json["name"],
        role: json["role"],
        email: json["email"],
