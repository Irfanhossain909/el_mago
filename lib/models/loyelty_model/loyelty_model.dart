...
class LoyeltyModel {
  ...
  LoyeltyModel({this.success, this.message, this.data});

  factory LoyeltyModel.fromRawJson(String str) =>
      LoyeltyModel.fromJson(json.decode(str));
...
class LoyeltyModelData {
  ...
  LoyeltyModelData({this.loyalty, this.availableRewards});

  factory LoyeltyModelData.fromRawJson(String str) =>
      LoyeltyModelData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory LoyeltyModelData.fromJson(
    Map<String, dynamic> json,
  ) => LoyeltyModelData(
    loyalty: json["loyalty"] == null ? null : Loyalty.fromJson(json["loyalty"]),
    availableRewards: json["availableRewards"] == null
        ? []
        : List<AvailableReward>.from(
            json["availableRewards"]!.map((x) => AvailableReward.fromJson(x)),
          ),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "availableRewards": availableRewards == null
        ? []
        : List<dynamic>.from(availableRewards!.map((x) => x.toJson())),
  };
}
...
class AvailableReward {
  ...
  factory AvailableReward.fromRawJson(String str) =>
      AvailableReward.fromJson(json.decode(str));
...
class Loyalty {
  ...
  factory Loyalty.fromJson(Map<String, dynamic> json) => Loyalty(
    ...
    rewardsRedeemed: json["rewardsRedeemed"] == null
        ? []
        : List<AvailableReward>.from(
            json["rewardsRedeemed"]!.map((x) => AvailableReward.fromJson(x)),
          ),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "rewardsRedeemed": rewardsRedeemed == null
        ? []
        : List<dynamic>.from(rewardsRedeemed!.map((x) => x.toJson())),
    "memberId": memberId,
